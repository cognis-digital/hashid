"""HASHID core — Identify hash types and estimate crack cost/feasibility."""
...
RULES = [
    ("HAS-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("HAS-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("HAS-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
